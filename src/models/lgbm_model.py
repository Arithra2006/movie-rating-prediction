...
def get_lgbm_model(params: dict = None):
    """Get LightGBM model with given or default params."""
    default_params = {
        'n_estimators': 300,
        'max_depth': 6,
        'learning_rate': 0.05,
...
def train_lgbm(X_train, y_train, X_val, y_val, params: dict = None):
...
def save_lgbm_model(model, filename: str = "lgbm_model.pkl"):
...
def load_lgbm_model(filename: str = "lgbm_model.pkl"):
...
if __name__ == "__main__":
    ...
    model, preds = train_lgbm(X_train, y_train, X_val, y_val)
